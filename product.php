...
<div class="container py-5 ">
	<div class="row mt-5 ml-5">
	 ...
	 -->
						<h2 class="card-title text-info"><?php echo $row['prod_name'];?></h2>
						<h3 class="card-title text-danger">Rs.<?php echo $row['price'];?></h3>
						<div class="quant">
							<button class="btn minus-btn disabled" onclick="minus()">-</button>
							<input type="text" id="quant" name="quantity"  value="4" class="form-control" />
